...
echo $i" |"$cy"     INFORMASI DIGITAL"$i"         |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" MR.Y"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" Denis S"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ Risky"$i"  |"
echo $i" |"$pu" Contack WhatsApp :"$ku" 08316989xxxx"$i"             |"
echo $i" |"$pu" Contack Gmail :"$ku" firmansyahandi343@gmail.com"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
echo $i"────────────────────────────────    ─────"
echo
echo $me"┌==="$bi"["$i"MR.Y"$bi"]"$me"======"$bi"["$i""Pilih Nomornya""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
sleep 2
echo $i"Bila Ada Kesalahan Kamu Bisa Nanya Sama Gwe"
sleep 2
echo $ku"WhatsApp :"$i" 08316989xxxx"
echo $ku"Facebook :"$i" Denis S"
sleep 2
echo $pur">> Support Saya Terus:) <<"
exit
fi
